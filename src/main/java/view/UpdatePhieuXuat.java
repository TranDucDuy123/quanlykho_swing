    ...
    private void btnNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapHangActionPerformed
        ...
        if (CTPhieu.isEmpty()) {
            ...
            for (var ct : CTPhieuOld) {
                SanPhamDAO.getInstance().updateSoLuong(ct.getMaMay(), SanPhamDAO.getInstance().selectById(ct.getMaSanPham()).getSoLuong() + ct.getSoLuong());
                System.out.println(ct.getSoLuong());
            }
            for (var ct : CTPhieu) {
                SanPhamDAO.getInstance().updateSoLuong(ct.getMaSanPham(), SanPhamDAO.getInstance().selectById(ct.getMaMay()).getSoLuong() - ct.getSoLuong());
                System.out.println(ct.getSoLuong());
            }
